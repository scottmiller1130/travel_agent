                            ...
                            "items": {
                                ...
                                "items": {
                                    ...
                                    "properties": {
                                        ...
                                        "cuisine": {"type": "string", "description": "Cuisine type for restaurant/food items e.g. 'Italian', 'Japanese street food'"},
                                        "menu_highlights": {
                                            "type": "array",
                                            "description": "2-4 must-order dishes or menu highlights for restaurant items",
                                            "items": {"type": "string"},
                                        },
                                        "reservation": {"type": "string", "description": "Reservation status or tip e.g. 'Book 2 weeks ahead', 'Walk-in only', 'Confirmed'"},
                                        "dietary_options": {"type": "string", "description": "Dietary accommodations e.g. 'Vegan options available', 'Gluten-free menu'"},
                                    },
